...
class approved_applications extends StatefulWidget {
  const approved_applications({Key? key}) : super(key: key);

  @override
  _approved_applicationsState createState() => _approved_applicationsState();
}

class _approved_applicationsState extends State<approved_applications> {
  bool loadData=false;
  bool noData=false;
  ...
  Future getApprovedApplication() async {
        ...
        child: Padding(
          ...
          child: loadData ?ListView.builder(
              ...
              itemBuilder:(BuildContext context,index){
                return jsonresponseData[index]['status'] == 'Approved' ?
                Card(
                    child: Padding(
